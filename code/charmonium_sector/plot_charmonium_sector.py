...
import os
import csv
from charmonium_sector import run_comparisons, ALPHA_S, B, C


def create_showcase():
    print("Gathering data from charmonium_sector.py...")
    ...
    fig_dir = "results/figures/charmonium_sector"
    ...
    ax1.set_ylim(-1.5, e1d_gem_bare + 1.0)
    ax1.set_title(
        f"Charmonium Radial Spectrum and Wavefunction Densities\n($\\alpha_s$={ALPHA_S}, b={B}, c={C})",
        fontsize=14,
    )
    ...
    csv_path = "results/tables/charmonium_sector_numerical_results.csv"
